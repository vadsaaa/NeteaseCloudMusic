...
import { View, Text, PanResponder, Animated, Easing, ActivityIndicator } from 'react-native'
...
export default class extends Component {
  constructor(props) {
    ...
    // !(this.props.onPulling || this.props.onPullOk || this.props.onPullRelease); //定义onPull***属性时scrollEnabled为false
  ...
  onShouldSetPanResponder = (e, gesture) => {
    ...
    return false
    /* eslint-unable no-underscore-dangle */
  }
  ...
  defaultTopIndicatorRender = (pulling, pullok, pullrelease) => {
    const { pullingText, pullokText, pullreleaseText } = this.props
    setTimeout(() => {
      if (pulling) {
